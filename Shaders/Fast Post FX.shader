Shader "PS Vita/Uber/Post FX" 
{
	...
	SubShader 
	{
		...
		//o.pos = v.vertex;//use object space input as clip space pos directly
		//o.uv = o.pos * 0.5 + 0.5;//use clip space pos as uv directly, still we need to transform from [-1,1] to [0,1], as tex2D() expect a uv inside [0,1]
